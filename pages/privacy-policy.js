...
const privacy = () => {
  return (
    <>
      <Head>
        <title>IG-Caption - Privacy Policy</title>
        <meta name="description" content="Free Status And Caption" />
        <link rel="icon" href="/android-chrome-512x512.png" />
      </Head>

      <div className="w-full flex justify-center">
        <div className="mx-4 lg:mx-20 my-8 rounded-lg px-4 shadow-2xl bg-[#e1e1e1] space-y-8 py-5">
          <h1 className="text-3xl mt-8">
            Privacy Policy for IGCaption - instagram-caption
          </h1>

          <p>
            At IGCaption - instagram-caption, accessible from
            http://igcaption.iceiy.com/, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types
            of information that is collected and recorded by IGCaption -
            instagram-caption and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in IGCaption - instagram-caption.
          ...
          <p>
            IGCaption - instagram-caption follows a standard procedure of using
          ...
          <p>
            ...
            advertising partners of IGCaption - instagram-caption.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on IGCaption -
            instagram-caption, which are sent directly to users' browser. They
          ...
          <p>
            Note that IGCaption - instagram-caption has no access to or control
          ...
          <p>
            IGCaption - instagram-caption's Privacy Policy does not apply to
          ...
          <p>
            IGCaption - instagram-caption does not knowingly collect any
